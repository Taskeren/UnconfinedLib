...
public final class Identifier implements Comparable<Identifier> {
    ...
    public static final SimpleCommandExceptionType ERROR_INVALID = new SimpleCommandExceptionType(Component.translatable(
        "argument.id.invalid"));
    ...
    public boolean equals(Object other) {
        if (this == other) {
            ...
            return other instanceof Identifier identifier && this.namespace.equals(identifier.namespace) && this.path.equals(
                    identifier.path);
        }
    }
